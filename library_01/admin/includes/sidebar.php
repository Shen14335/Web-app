			...
			<ul class="nav nav-tabs nav-stacked main-menu">
				...
				<li>
					...
					<ul>
						...
						<li><a class="submenu" href="borrowed_book.php"><i class="icon-file-alt"></i><span class="hidden-tablet">Borrowed Book</span></a></li>
					</ul>
				</li>
				...
				<li>
					...
					<ul>
						<li><a class="submenu" href="add_new_borrower.php"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add New Borrower</span></a></li>
						<li><a class="submenu" href="view_borrower.php"><i class="icon-file-alt"></i><span class="hidden-tablet"> View Borrower</span></a></li>
					</ul>
				</li>

				<li>
					<a class="dropmenu" href="#"><i class="icon-reorder"></i><span class="hidden-tablet"> UserManagement</span></a>
					<ul>
						<li><a class="submenu" href="add_new_user.php"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add New Users</span></a></li>
						<li><a class="submenu" href="view_user.php"><i class="icon-file-alt"></i><span class="hidden-tablet"> View Users</span></a></li>
					</ul>
				</li>
